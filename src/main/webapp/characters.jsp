<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<head>
		<%@ include file="./snippets/imports_head.jsp" %>
			<title>
				<f:message key="header.2" />
			</title>
			<link href="https://fonts.googleapis.com/css?family=Pathway+Gothic+One|Source+Sans+Pro:400"
				rel="stylesheet">
